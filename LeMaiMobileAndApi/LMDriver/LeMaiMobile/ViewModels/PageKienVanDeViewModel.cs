...
public partial class PageKienVanDeViewModel : GhViewModelBase<PageKienVanDe>
{
    public PageKienVanDeViewModel(INavigationService navigationService, IDialogService dialogService, Models.IStatusBar myStatuBar)
    ...
    [ObservableProperty]
    private ObservableCollection<KienVanDeDanhSachOutput> _listDanhSach = new ObservableCollection<KienVanDeDanhSachOutput>();
    private List<KienVanDeDanhSachOutput> _listDanhSachAll = new List<KienVanDeDanhSachOutput>();
    ...
    private async Task LoadDanhSachAsync()
    {
        ...
        try
        {
...

            {
                ...
                var response = await ExecuteApiAsync<List<KienVanDeDanhSachOutput>>(request);
                if (!response.isOk || response.data == null)
                {
                    return;
                }
    ...
    private async Task FilterVanDonAsync()
    {
        ...
        try
        {
            ...
            {
                ListDanhSach = new ObservableCollection<KienVanDeDanhSachOutput>(_listDanhSachAll);
                return;
            }
            ...
            ListDanhSach = new ObservableCollection<KienVanDeDanhSachOutput>(query.ToList());
        }
        catch (Exception ex)
        {
            await HandleExceptionAsync(ex);
    ...
    ViewKienVanDeFilterDate _groupDates = null;
    ...
    private async Task ShowFilterDateAsync()
    {
        ...
        try
        {
            ...
            _groupDates = new ViewKienVanDeFilterDate();
