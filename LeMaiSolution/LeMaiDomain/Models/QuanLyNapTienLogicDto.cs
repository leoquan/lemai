...
namespace LeMaiDomain.Models
{
	...
	public class QuanLyNapTienLogicInputDto
	{
	...
	public class QuanLyNapTienLogicOutputDto:view_GExpRequestMoney
	{
	}
	public class PostDebit
	{
		public DateTime LastDate { get; set; }
		public string PostReferCode { get; set; }
		public string PostReferName { get; set; }
		public int Balance { get; set; }
		public string QuanLy { get; set; }
		public string SoDienThoai { get; set; }
		public bool IsNapTien { get; set; }
