...
namespace GmailAPI.APIHelper
{
    public static class GmailAPIHelper
    {
        ...
        public static GmailService GetService()
        {
            ...
            using (FileStream stream = new FileStream(AppDomain.CurrentDomain.BaseDirectory + "ClientCredentials/token.json", 
                FileMode.Open, FileAccess.Read))
            {
                String FolderPath = Convert.ToString(AppDomain.CurrentDomain.BaseDirectory + "ClientCredentials/CredentialsInfo");
