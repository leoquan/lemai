...
{
    public class PrintDocumentLeMai : IDocumentPrint
    {
        ...
        // Font
        Font fontTimeNewRoman30Bold = new Font("Time New Roman", 30, FontStyle.Bold);
        Font fontTimeNewRoman20Bold = new Font("Time New Roman", 20, FontStyle.Bold);
        Font fontTimeNewRoman16Bold = new Font("Time New Roman", 16, FontStyle.Bold);
        ...
        private void Doc_PrintBill76x130(object sender, PrintPageEventArgs e)
        {
            ...
            else
            {
                // Line Đứng X2
                trucdung = 90;
                e.Graphics.DrawLine(blackPen, trucdung, 124, trucdung, 164);
                // Line Đứng X3
                trucdung = 220;
                e.Graphics.DrawLine(blackPen, trucdung, 124, trucdung, 164);
                ...
                if (split.Length >= 3)
                {
                    ...
                    drawRect = new RectangleF(0, 125, 90, fontTimeNewRoman20Bold.Height);
                    e.Graphics.DrawString(split[0], fontTimeNewRoman20Bold, drawBrush, drawRect, drawFormatCenter);
                    drawRect = new RectangleF(80, 125, 140, fontTimeNewRoman20Bold.Height);
                    e.Graphics.DrawString(split[1], fontTimeNewRoman20Bold, drawBrush, drawRect, drawFormatCenter);
                    drawRect = new RectangleF(220, 125, 60, fontTimeNewRoman20Bold.Height);
                    e.Graphics.DrawString(split[2], fontTimeNewRoman20Bold, drawBrush, drawRect, drawFormatCenter);
                }
            }
        ...
        private void Doc_PrintBill100x180(object sender, PrintPageEventArgs e)
        {
            ...
            int trucdung = 5;
            int trucngang = 0;
            if(string.IsNullOrEmpty(expCon.BT3Code)==false)
            {
                // QR CODE
                Image qrCode = RenderQrCode(expCon.BT3Code);
                // QR Code file
                e.Graphics.DrawImage(qrCode, 220, 490);
            }    
            ...
            e.Graphics.DrawString(string.Format("{0:HH:mm dd/MM/yyyy}", expCon.RegisterDate) + " KH:" + expCon.FeeWeight.ToString("N0") + " - T3:" + expCon.BillWeight.ToString("N0"), fontTimeNewRoman7, drawBrush, drawRect, drawFormatLeft);
            ...
            else
            {
                // Line Đứng X2
                trucdung = 120;
                e.Graphics.DrawLine(blackPen, trucdung, 201, trucdung, 253);
                // Line Đứng X3
                trucdung = 300;
                e.Graphics.DrawLine(blackPen, trucdung, 201, trucdung, 253);
                string[] split = expCon.PrintData.Split(';');
                ...
                {
                    // Tên dịch vụ print data
                    drawRect = new RectangleF(0, 205, 120, fontTimeNewRoman30Bold.Height);
                    e.Graphics.DrawString(split[0], fontTimeNewRoman30Bold, drawBrush, drawRect, drawFormatCenter);
                    drawRect = new RectangleF(120, 205, 180, fontTimeNewRoman30Bold.Height);
                    e.Graphics.DrawString(split[1], fontTimeNewRoman30Bold, drawBrush, drawRect, drawFormatCenter);
                    drawRect = new RectangleF(300, 205, 80, fontTimeNewRoman30Bold.Height);
                    e.Graphics.DrawString(split[2], fontTimeNewRoman30Bold, drawBrush, drawRect, drawFormatCenter);
                }
            ...
            //e.Graphics.DrawString("Kích thước " + expCon.GoodsW + " X " + expCon.GoodsH + " X " + expCon.GoodsL, fontTimeNewRoman8, drawBrush, drawRect, drawFormatLeft);
